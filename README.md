...
> 直接打开 [`index.html`](index.html) 即可使用（零安装，改参数实时出结果）。上方截图为默认参数（苏州 600 万、首付 33.3%、30 年、利率 3%、投资年化 5%）的完整渲染。
...
|------|------|------|
| 月供 | 1.6865 万/月 | — |
| 房产终值 / 组合终值(税前) | 1456.4 万 | 1603.5 万 |
| 买家净收益 / 租房净收益 | **1287.3 万** | **1384.2 万** |
| 盈亏平衡门槛 `g*` | — | **3.226 %/年** |
| 租金回报率 / 房贷利率 | 1.667% / 3.000% | （红灯：持有现金流为负） |

结论：**租房（定投）净胜约 96.9 万**；房价年化需超过 **3.226%** 买房才不输。
